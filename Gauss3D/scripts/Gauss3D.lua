...
Script.serveEvent("Gauss3D.OnMessage1", "OnMessage1", "string")
Script.serveEvent("Gauss3D.OnMessage2", "OnMessage2", "string")
...
local function filteringImage(heightMap, intensityMap)
    ...
    viewer2:clear()
    viewer2:addHeightmap({gaussImage, gaussintensityMap}, {}, {"Reflectance"})
    viewer2:present()
